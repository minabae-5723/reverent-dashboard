...
🔴 **다양성 원칙 (2026-05-29 사용자 지정)**: Page 5는 출자사업·GP선정(🅑)에 편중되지 말 것. **한국 증시(코스피·코스닥) 관련 기사를 우선**으로 가져오고, 🅑(펀드결성·출자)는 **최대 3건**으로 제한. 나머지 7건 이상은 증시 지수·수급·제도·증권업·거시 카테고리에서 골고루 발굴.

- 🅐 **정책/규제**: 금융위·한은·거래소·국세청 정책 (자본시장법, ETF 규제, RWA 완화, 공매도, 금투세, 상법 개정 등)
- 🅑 **펀드결성·GP선정**: 국민성장펀드 자펀드, 블라인드펀드 결성, 정책자금 위탁운용사 선정 — *⚠️ 최대 3건 제한*
